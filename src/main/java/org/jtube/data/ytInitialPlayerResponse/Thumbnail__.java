...
public class Thumbnail__ {
    ...
    @Valid
    private List<Thumbnail___> thumbnails = null;
    @JsonIgnore
    @Valid
    ...
    public Thumbnail__(List<Thumbnail___> thumbnails) {
        super();
        this.thumbnails = thumbnails;
    }

    @JsonProperty("thumbnails")
    public List<Thumbnail___> getThumbnails() {
        return thumbnails;
    }

    @JsonProperty("thumbnails")
    public void setThumbnails(List<Thumbnail___> thumbnails) {
        this.thumbnails = thumbnails;
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof Thumbnail__)) {
            return false;
        }
        Thumbnail__ rhs = ((Thumbnail__) other);
