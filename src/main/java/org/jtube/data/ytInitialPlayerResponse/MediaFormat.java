...
public class MediaFormat implements Comparable<MediaFormat> {
    ...
    public String toString() {
        MediaFormatType formatType = getMediaFormatType();
        return "[" + mimeType + "; "
                + (formatType.equals(VIDEO) || formatType.equals(AUDIO_VIDEO) ? qualityLabel + "; " + fps + "fps; " : "")
                + (formatType.equals(AUDIO) || formatType.equals(AUDIO_VIDEO) ? audioSampleRate + "kHz; " : "")
                + averageBitrate + "bps.]";
    }
    ...
    public boolean equals(Object other) {
        ...
        MediaFormat rhs = ((MediaFormat) other);
