...
public class Chromecast {
    ...
    public Chromecast(boolean track, Data data, boolean group) {
        super();
        this.track = track;
        this.data = data;
        this.group = group;
    ...
    public Chromecast withTrack(boolean track) {
        this.track = track;
        return this;
    }
    ...
    public Chromecast withData(Data data) {
        this.data = data;
        return this;
    }
    ...
    public Chromecast withGroup(boolean group) {
        this.group = group;
        return this;
    }
    ...
    public Chromecast withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        Chromecast rhs = ((Chromecast) other);
